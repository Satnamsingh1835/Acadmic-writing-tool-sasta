...
class SourceRecord:
 ...
 main_argument:str=""
 secondary_arguments:list[str]=field(default_factory=list)
 concepts:list[str]=field(default_factory=list)
 definitions:list[dict[str,Any]]=field(default_factory=list)
 theoretical_framework:list[str]=field(default_factory=list)
 methodology:str=""
 ...
 historical_claims:list[str]=field(default_factory=list)
 ...
 literature_sections:list[str]=field(default_factory=list)
 relevance:str=""
